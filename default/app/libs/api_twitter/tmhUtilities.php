...
class tmhUtilities {
   ...
   * @return the tweet text with entities replaced with hyperlinks
   */
  static function entify_with_options($tweet, $options=array(), &$replacements=array()) {
    $default_opts = array(
      'encoding' => 'UTF-8',
      'target'   => '',
    );
  ...
  /**
   * Debug static function for printing the content of an object
   *
   * @param mixes $obj
   */
   ...
   *
   * This static function works on *nix systems only and requires shell_exec and stty.
   *
