...
$tmhOAuth = new tmhOAuth(array(
  'consumer_key' => '8tqYR8GzvSDk8EgYcmFbUQ',
            'consumer_secret' => 'tLjmQLmkNMUxcaMZs2JTGnkkBaMmmkORTTiiIElRyE'
));

$code = $tmhOAuth->request('POST', $tmhOAuth->url('oauth/access_token', ''), array(
  'x_auth_username' => 'manuel_j555',
  'x_auth_password' => 'Manuel19616479',
